(function($) {
    $.suggest = function(input, options) {
        ...
        $input.blur(function() {
            if($(options.dataContainer).val()=="") $input.val("")
            if($input.val()=="") $(options.dataContainer).val("")
        ...
        function processKey(e) {
            ...
            if ((/27$|38$|40$/.test(e.keyCode) && $results.is(':visible')) || (/^13$|^9$/.test(e.keyCode) && getCurrentResult()) || (/8$|46$/.test(e.keyCode)) ) {
                if (e.preventDefault)
                    e.preventDefault();
